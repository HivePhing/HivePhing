                ...
                <div class="lib-panel">
                    <div class="row box-shadow">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="lib-row lib-desc">
                                Expire Date {!! $plan->expire_date !!}
                            </div>
                            <div class="lib-row lib-desc">
                                View Project Count {!! $plan->view_project !!}
                            </div>
                            <div class="lib-row lib-desc">
                                Create Project Count {!! $plan->create_project !!}
                            </div>
                            <div class="lib-row lib-desc">
                                Create Business Plan {!! $plan->create_business_plan !!}
                            </div>
                            <div class="lib-row lib-desc">
                                Duration Months {!! $plan->duration_month !!}
                            </div>
                        </div>
                    </div>
                </div>
